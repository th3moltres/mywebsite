...
=================================== */
    $("#contact").submit(function (e) {
        ...
        var telefono = $("#cf-telefono").val();
        var ciudad = $("#cf-ciudad").val();
        var subject = $("#cf-subject").val();
        var message = $("#cf-message").val();
        var dataString = 'name=' + name + '&email=' + email + '&subject=' + subject + '&message=' + message + '&telefono=' + telefono + '&ciudad=' + ciudad;
